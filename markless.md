...
> ### using the three backquote  equals== "  `  " and add the program language that you want to note!
...
<!--using "[^ sign]" in sentence nearly to express footnote and you should add [^ this word] : in the same time on the page foot to express the link to show the mean--> 
...
<!--using "---" to Split the different sections -->
